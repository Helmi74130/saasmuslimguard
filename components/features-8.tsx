            ...
            <div className="@container relative mx-auto max-w-7xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        ...
                        >
                            <Card className="group relative flex h-full overflow-hidden border border-[#0C3E6A]/10 shadow-zinc-950/5 transition-colors hover:border-[#0C3E6A]/20">
                        ...
                        >
                            <Card className="group relative h-full overflow-hidden border border-purple-400/10 shadow-zinc-950/5 transition-colors hover:border-purple-400/20">
                        ...
                        <motion.div
                            ...
                            className="col-span-full sm:col-span-3 lg:col-span-2"
                        >
                            <Card className="group relative h-full overflow-hidden border border-amber-400/10 shadow-zinc-950/5 transition-colors hover:border-amber-400/20">
                                <CardContent className="pt-6">
                                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <motion.div
                                            animate={{
                                    ...
                                    <div className="relative z-10 mt-6 space-y-2 text-center">
                                        <h2 className="text-lg font-medium text-[#003463] transition dark:text-white">Suivi en temps réel</h2>
                                        <p className="text-foreground">Suivez l'activité de navigation de vos enfants en un coup d'œil.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="card variant-outlined group relative h-full overflow-hidden border border-rose-400/10 shadow-zinc-950/5 transition-colors hover:border-rose-400/20">
                                        ...
                                        <svg
                                            ...
                                            <defs>
                                                <linearGradient
                                                    ...
                                                    <stop
                                                        className="text-rose-500/15 dark:text-rose-500/35"
                        ...
                        <motion.div
                            ...
                            className="col-span-full lg:col-span-3"
                        >
                            <Card className="card variant-outlined group relative h-full overflow-hidden border border-teal-400/10 shadow-zinc-950/5 transition-colors hover:border-teal-400/20">
                                <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        >
                                            <Users
                                                className="m-auto size-6 text-teal-500"
                                                strokeWidth={1.5}
                                            />
                                        </motion.div>
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium text-[#003463] transition dark:text-white">Protégez ceux qui comptent le plus</h2>
                                            <p className="text-foreground">Un bouclier numérique intelligent pour préserver vos enfants des dangers du web.</p>
                                        </div>
                                    </div>
                                    <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                        <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                            ...
                                            >
                                                <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Adam</span>
                                            ...
                                            >
                                                ...
                                                <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Zaynab</span>
                                            </motion.div>
                                            <motion.div
                                                className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2"
                                                initial={{ opacity: 0, x: 20 }}
                                            ...
                                            >
                                                <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Karim</span>
                                                <div className="ring-background size-7 ring-4">
                                                    <img
                                                        className="size-full rounded-full"
